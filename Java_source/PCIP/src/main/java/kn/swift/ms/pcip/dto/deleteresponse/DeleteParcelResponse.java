...
@XmlRootElement(name = "DeleteParcelResponse", namespace = "http://xlogics.eu/blackbox")
public class DeleteParcelResponse {

    @XmlElement(name = "ExitStatus", namespace = "http://xlogics.eu/blackbox", required = true)
    protected DeleteParcelResponse.ExitStatus exitStatus;
    @XmlElement(name = "OutputParameters", namespace = "http://xlogics.eu/blackbox", required = true)
    protected DeleteParcelResponse.OutputParameters outputParameters;
     ...
     * @return
     *     possible object is
     *     {@link DeleteParcelResponse.ExitStatus }
     *     
     */
    public DeleteParcelResponse.ExitStatus getExitStatus() {
        return exitStatus;
    }
     ...
     *     
     */
    public void setExitStatus(DeleteParcelResponse.ExitStatus value) {
     ...
     * @return
     *     possible object is
     *     {@link DeleteParcelResponse.OutputParameters }
     *     
     */
    public DeleteParcelResponse.OutputParameters getOutputParameters() {
     ...
     *     
     */
    public void setOutputParameters(DeleteParcelResponse.OutputParameters value) {
    ...
    public static class ExitStatus {
        ...
        protected DeleteParcelResponse.ExitStatus.StatusDetails statusDetails;
         ...
         * @return
         *     possible object is
         *     {@link DeleteParcelResponse.ExitStatus.StatusDetails }
         *     
         */
        public DeleteParcelResponse.ExitStatus.StatusDetails getStatusDetails() {
         ...
         *     
         */
        public void setStatusDetails(DeleteParcelResponse.ExitStatus.StatusDetails value) {
        ...
        public static class StatusDetails {
            ...
            protected List<DeleteParcelResponse.ExitStatus.StatusDetails.StatusDetail> statusDetail;
             ...
             * {@link DeleteParcelResponse.ExitStatus.StatusDetails.StatusDetail }
             * 
             * 
             */
            public List<DeleteParcelResponse.ExitStatus.StatusDetails.StatusDetail> getStatusDetail() {
                if (statusDetail == null) {
                    statusDetail = new ArrayList<DeleteParcelResponse.ExitStatus.StatusDetails.StatusDetail>();
                }
    ...
    public static class OutputParameters {
        ...
        protected List<DeleteParcelResponse.OutputParameters.ShippingParameter> shippingParameter;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link DeleteParcelResponse.OutputParameters.ShippingParameter }
         * 
         * 
         */
        public List<DeleteParcelResponse.OutputParameters.ShippingParameter> getShippingParameter() {
            if (shippingParameter == null) {
                shippingParameter = new ArrayList<DeleteParcelResponse.OutputParameters.ShippingParameter>();
            }
