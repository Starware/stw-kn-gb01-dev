...
@XmlRootElement(name = "PrintParcelResponse", namespace = "http://xlogics.eu/blackbox")
public class PrintParcelResponse {

    @XmlElement(name = "ExitStatus", namespace = "http://xlogics.eu/blackbox", required = true)
    protected PrintParcelResponse.ExitStatus exitStatus;
    @XmlElement(name = "OutputParameters", namespace = "http://xlogics.eu/blackbox", required = true)
    protected PrintParcelResponse.OutputParameters outputParameters;
     ...
     * @return
     *     possible object is
     *     {@link PrintParcelResponse.ExitStatus }
     *     
     */
    public PrintParcelResponse.ExitStatus getExitStatus() {
        return exitStatus;
    }
     ...
     *     
     */
    public void setExitStatus(PrintParcelResponse.ExitStatus value) {
     ...
     * @return
     *     possible object is
     *     {@link PrintParcelResponse.OutputParameters }
     *     
     */
    public PrintParcelResponse.OutputParameters getOutputParameters() {
     ...
     *     
     */
    public void setOutputParameters(PrintParcelResponse.OutputParameters value) {
    ...
    public static class ExitStatus {
        ...
        protected PrintParcelResponse.ExitStatus.StatusDetails statusDetails;
         ...
         * @return
         *     possible object is
         *     {@link PrintParcelResponse.ExitStatus.StatusDetails }
         *     
         */
        public PrintParcelResponse.ExitStatus.StatusDetails getStatusDetails() {
         ...
         *     
         */
        public void setStatusDetails(PrintParcelResponse.ExitStatus.StatusDetails value) {
        ...
        public static class StatusDetails {
            ...
            protected List<PrintParcelResponse.ExitStatus.StatusDetails.StatusDetail> statusDetail;
             ...
             * {@link PrintParcelResponse.ExitStatus.StatusDetails.StatusDetail }
             * 
             * 
             */
            public List<PrintParcelResponse.ExitStatus.StatusDetails.StatusDetail> getStatusDetail() {
                if (statusDetail == null) {
                    statusDetail = new ArrayList<PrintParcelResponse.ExitStatus.StatusDetails.StatusDetail>();
                }
    ...
    public static class OutputParameters {
        ...
        protected List<PrintParcelResponse.OutputParameters.ShippingParameter> shippingParameter;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link PrintParcelResponse.OutputParameters.ShippingParameter }
         * 
         * 
         */
        public List<PrintParcelResponse.OutputParameters.ShippingParameter> getShippingParameter() {
            if (shippingParameter == null) {
                shippingParameter = new ArrayList<PrintParcelResponse.OutputParameters.ShippingParameter>();
            }
